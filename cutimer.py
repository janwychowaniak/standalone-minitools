...
class Datetime:
    ...
    def get_time(self):
        return '%s:%s:%s' % (zerolead(self.start_moment.hour), zerolead(
            self.start_moment.minute), zerolead(self.start_moment.second))
...
if __name__ == '__main__':
    ...
    remaining_time = Datetime(int(remtime_s_elems[0]), int(
        remtime_s_elems[1]), int(remtime_s_elems[2]))
